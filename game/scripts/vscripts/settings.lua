...
CUSTOM_STAGE_TIMER = false 				-- Needed for the timers below it to function
...
BONUS_XP_PERCENTAGE = 50				-- How much bonus XP percentage do heroes receive? (100 = 200% total xp, 200 = 300% total xp etc)
...
--for i=1,MAX_LEVEL do
  --XP_PER_LEVEL_TABLE[i] = 280+(100*(i-1))
--end
...
FORCE_PICKED_HERO = "npc_dota_hero_techies"                 -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.
